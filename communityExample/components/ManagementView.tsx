...
import { 
  ...
  BarChart, Users as UsersIcon, MessageSquare, AlertCircle,
  Image as ImageIcon, CheckCircle, Search, UserPlus, X, Send,
  ChevronRight, FileVideo, Video, Bell, ArrowLeft, Filter, Globe,
  LayoutList
} from 'lucide-react';
import { Post, Channel, User, PostReport } from '../types';
...
const ManagementView: React.FC<ManagementViewProps> = ({ 
  ...
  const [activeSubTab, setActiveSubTab] = useState<'feed' | 'moderate' | 'channels' | 'announcement' | 'reports'>('moderate');
  ...
  const handleToggleAdmin = (channelId: string, user: User) => {
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                       <div>
                          ...
                          <div className="relative w-20 h-20 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 flex items-center justify-center overflow-hidden cursor-pointer group">
                             {newChannel.thumbnail ? <img src={newChannel.thumbnail} className="w-full h-full object-cover" /> : <ImageIcon className="text-gray-300" />}
                      ...
                      <div className="grid grid-cols-2 gap-4">
                         <div>
                            ...
                            <select 
                              ...
                              onChange={(e) => setNewChannel({...newChannel, accessType: e.target.value as any})}
                              className="w-full bg-gray-50 border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-[#00ADEF]/20"
                            >
                         ...
                         <div>
                            ...
                            <select 
                              ...
                              onChange={(e) => setNewChannel({...newChannel, gradeRange: e.target.value as any})}
                              className="w-full bg-gray-50 border-none rounded-2xl p-4 text-sm focus:ring-2 focus:ring-[#00ADEF]/20"
                            >
