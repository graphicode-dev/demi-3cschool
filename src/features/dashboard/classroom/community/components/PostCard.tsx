    ...
    return (
        ...
        >
            ...
            {post.category && post.category !== "General" && (
                <div
                    className={`px-8 py-3 flex items-center justify-between border-b dark:border-gray-700 ${categoryColors[post.category]}`}
                >
                    ...
                    {post.status && (
                        <span
                            className={`text-[9px] font-black px-3 py-1 rounded-full border uppercase tracking-tighter ${post.status === "Solved" ? "bg-emerald-500 text-white border-emerald-600" : "bg-white text-current border-current"}`}
                        >
                            {post.status}
                        </span>
                    )}
            ...
            <div className="p-8">
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <p className="text-[15px] font-black text-gray-800 dark:text-white tracking-tight">
                                    {post.author.name}
                                    {post.feeling && (
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="text-gray-300 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-300 p-2.5 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl transition-all"
                        >
                    ...
                    {isEditing ? (
                        <div className="animate-in fade-in slide-in-from-top-1">
                            <textarea
                                ...
                                className="w-full bg-gray-50 dark:bg-gray-700 border border-gray-100 dark:border-gray-600 rounded-2xl p-4 text-[15px] text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-[#00ADEF]/20 outline-none h-32 mb-3"
                            />
                ...
                {post.poll && (
                    <div className="bg-[#f8fafc] dark:bg-gray-700 border border-gray-100 dark:border-gray-600 rounded-3xl p-6 mb-6">
                        <h4 className="text-[14px] font-black text-gray-800 dark:text-white mb-5 flex items-center gap-2">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-50 dark:border-gray-700">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className={`p-2.5 rounded-xl transition-all ${post.isPinned ? "text-[#00ADEF] bg-[#E0F4FF] dark:bg-[#00ADEF]/20" : "text-gray-300 dark:text-gray-500 hover:text-[#00ADEF] hover:bg-gray-50 dark:hover:bg-gray-700"}`}
                        >
                            <Pin
                                size={18}
                        ...
                        <button
                            ...
                            className={`p-2.5 rounded-xl transition-all ${post.isSaved ? "text-[#00ADEF] bg-[#E0F4FF] dark:bg-[#00ADEF]/20" : "text-gray-300 dark:text-gray-500 hover:text-[#00ADEF] hover:bg-gray-50 dark:hover:bg-gray-700"}`}
                        >
                            <Bookmark
                                size={20}
                ...
                message={
                    <div className="space-y-3">
                        ...
                        <input
                            ...
                            placeholder={t(
                                "post.reportPlaceholder",
                                "Enter reason..."
                            )}
                            className="w-full px-4 py-2 border border-gray-200 dark:border-gray-600 rounded-lg text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none"
                        />
                    </div>
                }
                variant="warning"
                confirmText={t("post.report")}
                cancelText={t("post.cancel")}
