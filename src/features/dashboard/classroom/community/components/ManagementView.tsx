                ...
                <div className="mb-10">
                        ...
                        <div className="p-8 flex items-start justify-between">
                            <div className="flex gap-6">
                                <img
                                    ...
                                    className="w-20 h-20 rounded-2xl border-4 border-white shadow-lg -mt-16 relative z-10 bg-white"
                                    alt=""
                                />
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <span className="px-2 py-0.5 bg-[#E0F4FF] text-[#00ADEF] text-[10px] font-black rounded uppercase">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 space-y-6">
                            <h4 className="font-black text-gray-800 uppercase tracking-widest text-xs px-2">
                                Channel Posts
                            </h4>
                            ...
                            {channelPosts.length === 0 && (
                                <div className="p-10 text-center bg-white border border-dashed border-gray-200 rounded-[32px]">
                                    <p className="text-gray-400 font-medium">
                                        No official posts in this channel yet.
                                    </p>
                                </div>
                            )}
                        </div>
                        <div>
                            <div className="bg-white rounded-[32px] border border-gray-100 p-7 shadow-sm sticky top-24">
                                <h4 className="font-black text-gray-800 text-[13px] uppercase mb-6 tracking-widest">
                                    Admin Control
                                </h4>
                                <button className="w-full py-4 bg-[#00ADEF] text-white rounded-2xl font-black text-sm mb-3">
                                    Add Official Post
                                </button>
                                <button className="w-full py-4 bg-gray-50 text-gray-500 rounded-2xl font-black text-sm">
                                    Channel Settings
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 font-medium text-sm">
                                    Moderate content and manage academy
                                    channels.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2">
                                    ...
                                    {reports.length === 0 ? (
                                        <div className="p-20 text-center bg-white rounded-[40px] border border-dashed border-gray-200">
                                            ...
                                            <p className="text-gray-400 text-sm font-medium">
                                                Your community is behaving well!
                                            </p>
                                        </div>
                                    ) : (
                                        reports.map((report) => {
                                            ...
                                            return (
                                                <div
                                                    key={report.id}
                                                    className="bg-white p-6 rounded-landing-card border border-red-100 shadow-sm"
                                                >
                                                    <div className="flex items-center justify-between mb-4">
                                                        <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex gap-2">
                                                            <button
                                                                ...
                                                                className="px-3 py-1 bg-gray-50 text-gray-400 text-[10px] font-black rounded-lg hover:bg-gray-100"
                                                            >
                                                                Dismiss
                                                            </button>
                                                            <button
                            ...
                            {activeSubTab === "moderate" && (
                                <div className="space-y-4">
                                    ...
                                    {filteredPosts.map((post) => (
                                        <div
                                            key={post.id}
                                            className="bg-white p-6 rounded-landing-card border border-gray-100 shadow-sm flex items-start justify-between group"
                                        >
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        {(post.reportCount ||
                                                            0) > 0 && (
                                                            <span className="text-[10px] px-2 py-0.5 bg-red-50 text-red-500 font-black rounded-full border border-red-100">
                                                                {
                                                                    post.reportCount
                                                                }{" "}
                                                                Reports
                                                    ...
                                                    <p className="text-gray-600 text-[13px] leading-relaxed line-clamp-2 max-w-lg">
                                                        {post.content}
                                                    </p>
                                                </div>
                                            </div>
                                            <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button
                                                    ...
                                                    className="p-2 bg-gray-50 text-gray-400 rounded-lg hover:bg-gray-100"
                                                >
                                                    <Filter size={16} />
                                                </button>
                                                <button
                                                ...
                                                >
                                                    ...
                                                    {selectedChannelForAdmins ===
                                                        ...
                                                        <div className="p-4 bg-[#fcfdfe] border-t border-gray-50 animate-in slide-in-from-top-2">
                                                            <h5 className="text-[10px] font-black text-gray-400 uppercase mb-3">
                                                                Manage Admins
                                                            </h5>
                            ...
                            {activeSubTab === "announcement" && (
                                <div className="bg-white rounded-[32px] border border-gray-100 p-8 shadow-sm">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-gray-50 border-none rounded-landing-card p-6 text-[15px] focus:ring-2 focus:ring-[#00ADEF]/20 outline-none h-40 mb-6"
                                    />
                                    <button
                                        onClick={() => {
                            ...
                            {activeSubTab === "post" && (
                                <div className="bg-white rounded-[32px] border border-gray-100 p-8 shadow-sm">
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <label className="text-[11px] font-black text-gray-400 uppercase mb-2 block tracking-widest">
                                                Select Target
                                            </label>
                                            <select
                                        ...
                                        <div>
                                            <textarea
                                                ...
                                                className="w-full bg-gray-50 border-none rounded-landing-card p-6 text-[15px] focus:ring-2 focus:ring-[#00ADEF]/20 outline-none h-40"
                                            />
                                        </div>
                                        ...
                                        <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="p-4 bg-gray-50 text-gray-400 hover:text-[#00ADEF] rounded-2xl transition-all"
                                                >
                                                    <ImageIcon size={20} />
                                                </button>
                                                <button
                        ...
                        <div className="space-y-6">
                            <div className="bg-[#fcfdfe] rounded-[32px] border border-[#00ADEF]/10 p-7">
                                <h4 className="font-black text-gray-800 text-[13px] uppercase tracking-widest mb-6">
                                    ...
                                    {reports.length > 0 ? (
                                        <div className="space-y-3">
                                            {reports.slice(0, 3).map((r) => (
                                                <div
                                                    key={r.id}
                                                    className="p-3 bg-red-50 rounded-xl border border-red-100 flex items-center justify-between"
                                                >
                                                    <div>
