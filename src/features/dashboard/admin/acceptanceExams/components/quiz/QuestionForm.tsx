...
import type { NewAcceptanceExamQuestionFormData, QuestionOptionUI } from "../../types";

interface QuestionFormProps {
    question: NewAcceptanceExamQuestionFormData;
    onChange: (question: NewAcceptanceExamQuestionFormData) => void;
    onSave: () => void;
    onCancel: () => void;
    isDisabled?: boolean;
    isPending?: boolean;
...
export function QuestionForm({
    ...
    const handleTypeChange = (newType: NewAcceptanceExamQuestionFormData["type"]) => {
        onChange({
            ...question,
            type: newType,
            options:
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 mb-4">
            <h5 className="font-medium text-gray-900 dark:text-white mb-3">
                {t("learning:levels.quiz.newQuestion", "New Question")}
            </h5>
            <div className="space-y-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        {t("learning:levels.quiz.questionText", "Question")}
                    </label>
                    <textarea
                        ...
                        rows={2}
                        placeholder={t(
                            "learning:levels.quiz.questionPlaceholder",
                            "Enter your question"
                        )}
                    />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            {t("learning:levels.quiz.questionType", "Type")}
                        </label>
                        <select
                            value={question.type}
                            onChange={(e) =>
                                handleTypeChange(
                                    e.target
                                        .value as NewAcceptanceExamQuestionFormData["type"]
                                )
                            }
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            {t("learning:levels.quiz.points", "Points")}
                        </label>
                        <input
                            type="number"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            {t("learning:levels.quiz.order", "Order")}
                        </label>
                        <input
                            type="number"
                        ...
                        <div className="flex items-center justify-between mb-2">
                            ...
                            {question.type !== "true_false" && (
                                ...
                                >
                                    +{" "}
                                    {t(
                                        "learning:levels.quiz.addOption",
                                        "Add Option"
                                    )}
                                </button>
                            )}
                            ...
                            {question.options.map((option, index) => (
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        placeholder={t(
                                            "learning:levels.quiz.optionPlaceholder",
                                            "Option text"
                                        )}
                                    />
                                    {question.type !== "true_false" &&
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={2}
                        placeholder={t(
                            "learning:levels.quiz.explanationPlaceholder",
            ...
            <div className="flex justify-end gap-3 mt-4">
                ...
                >
                    {isPending
                        ...
                        : t(
                              "learning:levels.quiz.saveQuestion",
                              "Save Question"
                          )}
                </button>
            </div>
