...
export function AcceptanceExamForm({
    quiz,
    onChange,
    onSave,
    onCancel,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        {t(
                            "learning:levels.quiz.timeLimit",
                            "Time Limit (minutes)"
                        )}
                    </label>
                    <input
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        {t(
                            "learning:levels.quiz.passingScore",
                            "Passing Score (%)"
                        )}
                    </label>
                    <input
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        {t("learning:levels.quiz.maxAttempts", "Max Attempts")}
                    </label>
                    <input
                        type="number"
                ...
                <div className="flex items-center gap-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        <span className="text-sm text-gray-700 dark:text-gray-300">
                            {t(
                                "learning:levels.quiz.shuffleQuestions",
                                "Shuffle Questions"
                            )}
                        </span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                        ...
                        <span className="text-sm text-gray-700 dark:text-gray-300">
                            {t(
                                "learning:levels.quiz.showAnswers",
                                "Show Answers"
                            )}
                        </span>
                    </label>
...
export default AcceptanceExamForm;
