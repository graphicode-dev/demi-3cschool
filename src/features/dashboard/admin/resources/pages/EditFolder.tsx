 ...
 * EditFolder Page
 *
 * Page for editing an existing resource folder.
 */
...
import { PageWrapper, LoadingState } from "@/design-system";
...
export function EditFolder() {
    ...
    if (isLoading) {
        return (
            <PageWrapper pageHeaderProps={{ title: t("folder.edit") }}>
                <LoadingState />
            </PageWrapper>
        );
    }
