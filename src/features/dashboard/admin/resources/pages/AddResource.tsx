 ...
 * AddResource Page
 *
 * Page for adding a new resource to a folder.
 */
        ...
        >
            <form onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-8 text-center cursor-pointer hover:border-brand-500 transition-colors bg-gray-50 dark:bg-gray-900/50"
                            >
                                <input
                                    ref={fileInputRef}
                                    type="file"
                                ...
                                />
                                <Upload className="size-8 mx-auto text-gray-400 mb-3" />
                                {selectedFile ? (
                                    ...
                                    <>
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
                                            {t("resource.dragAndDrop")}
                                        </p>
                                        <button
                                            type="button"
                                            className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
                                        >
                                            {t("resource.chooseFile")}
                                        </button>
                                    </>
                                )}
                            </div>
                ...
                <div className="flex items-center gap-3 mt-6">
                    <button
                        type="submit"
                        disabled={createResource.isPending || !selectedFile}
