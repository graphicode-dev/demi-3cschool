            ...
            >
                <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
                    {user?.image ? (
                        ...
                        <div className="bg-gray-200 dark:bg-gray-700 rounded-full h-11 w-11 flex items-center justify-center">
                ...
                <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
                    <li>
                        <DropdownItem
                            ...
                            tag="a"
                            to={paths.dashboard.classroom.profile()}
                    ...
                    {/* {user?.role?.name === "admin" && (
                        <li>
                            <DropdownItem
                                ...
                                tag="a"
                                to={
                                    paths.dashboard.settings?.subRoutes?.general
                                        ?.links?.main?.href
                                }
                                className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
                            >
                    ...
                    {/* <li>
                        <DropdownItem
                            ...
                            tag="a"
                            to={
                                paths.dashboard.support?.links?.ticketList?.href
                            }
                            className="flex items-center gap-3 px-3 py-2 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
                        >
                            <svg
